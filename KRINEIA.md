...
This is the repo-local KRINEIA manifest for `hummbl-dev/V3SP3R`.
...
governance_profile:
  ...
  fork_of: "elder-plinius/V3SP3R"

chains:
  primary:
    chain_id: "V3SP3R-primary"
...
This repository is an archived fork of `elder-plinius/V3SP3R`. No KRINEIA chain is bootstrapped. If this fork is ever un-archived and brought into active development, it must:
